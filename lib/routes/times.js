        ...
        if(req.query.route_id != null){
                if(req.query.stop_id != null){
                        if(req.query.day != null){
                                ...
                                models.sequelize.query("SELECT departure_time,trip_id,arrival_time from "+req.query.schema+".gtfs_stop_times where stop_id=:stop_id and trip_id in("+trips+") order by departure_time",
